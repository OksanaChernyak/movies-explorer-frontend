...
function MoviesCard({movie, handleMovieDelete, savedMovies, handleMovieLike}) {
    ...
    return (
        <li className="movie">
            ...
            {location.pathname === "/movies" ? (
                <button className={`${isLiked ? "movie__like-button_active" : "movie__like-button"}`} type="button"
